...
Then create the stable Invariant Position PDA, fund its Position-owned USDC token account in the fork, and create its Position-owned AAPLon Token-2022 account.
...
COVENANT_DESTINATION_TOKEN_ACCOUNT=<POSITION_AAPLON_ACCOUNT> \
